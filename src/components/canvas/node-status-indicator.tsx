  ...
  return (
    <>
      ...
      `}
        ...
        <div
          className={`absolute inset-0 overflow-hidden rounded-[7px] ${className}`}
        >
...
export const NodeStatusIndicator = ({
  ...
  switch (status) {
    ...
    case "success":
      return (
        <StatusBorder className={`border-emerald-600 ${className}`}>
          {children}
        </StatusBorder>
      );
    case "error":
      return (
        <StatusBorder className={`border-red-400 ${className}`}>
          {children}
        </StatusBorder>
      );
    default:
