                ...
                <div className="bg-muted relative z-20 rounded-full border p-1">
                  ...
                  >
                    <img
                      ...
                      className="text-blue-500 invert dark:block hidden"
                    />
                    <img
                      src={"/logo/only-logo.svg"}
                      className="text-blue-500  dark:hidden block"
                    />
                  </IntegrationCard>
                </div>
              </div>
...
const IntegrationCard = ({
  ...
  return (
    <div
      className={cn(
        "relative z-30 flex size-12 rounded-full border shadow-sm shadow-black/5 ",
        className
      )}
    >
