...
const Footer = () => {
  return (
    <div className=" flex justify-center ">
      <section className=" w-7xl m-4 ">
        <div className="  grid md:grid-cols-[350px_1fr]  grid-cols-1 gap-1 sm:gap-3">
          <img
            className=" rounded-xl border object-cover h-full w-full "
            src="https://res.cloudinary.com/dz12pywzs/image/upload/v1761390178/photo_2025-10-18_16-44-46_w5ybit.jpg"
            alt="Vansh Nagar"
          />
          <div className="border bg-background  flex flex-col  rounded-xl w-full p-1 sm:p-3 gap-3">
            <Card className=" h-full bg-accent bg-diagonal-grid flex justify-between  ">
              <CardHeader>
                {" "}
