        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className={`cursor-pointer ${showExplorer ? "[&_svg]:text-[#FF4A00]" : ""}`}
            >
              <File />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className={`cursor-pointer ${showTerminal ? "[&_svg]:text-[#FF4A00]" : ""}`}
            >
              <Terminal />
            </Button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className={`cursor-pointer ${showAiChat ? "[&_svg]:text-[#FF4A00]" : ""}`}
            >
              <BotMessageSquare />
            </Button>
          </TooltipTrigger>
